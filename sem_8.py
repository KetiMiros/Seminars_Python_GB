...
# ====================================
# # https://pastebin.com/
# model-view-Controller  или MVC
# ======================================
# fio = {'Иванов Иван': ['897097', 'работник'],
#        'Петров Петр': ['35346', 'не раб']}
...
# def create(id: int, surname: str, name: str, number: str, discrip: str) -> dict:  # data_base
